...
export default function Footer() {
  ...
  const handleAcceptCookies = () => {
    ...
    // Здесь можно добавить логику для фактической установки cookies
    // Например, включить аналитику и т.д.
  };
  ...
  return (
    <>
      ...
      {showCookieBanner && (
        <div className="fixed bottom-0 left-0 right-0 z-50 p-4 md:p-6">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 p-4 md:p-6 backdrop-blur-sm bg-white/95">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex-1 text-sm text-gray-700">
                  <p>
                    Мы используем технические cookie — они необходимы для работы сайта. Аналитические cookie (Яндекс.Метрика) используются с вашего согласия для сбора статистики.{' '}
                    <a href="/privacy" className="text-[#6f43f8] hover:underline font-medium">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="px-6 py-3 text-sm font-medium text-white bg-[#6f43f8] rounded-full hover:bg-[#5c36d9] transition-colors shadow-md"
                  >
                    Принять все cookie
                  </button>
                  <button
      ...
      <footer className="flex justify-center px-4 md:px-16 py-8 md:py-16">
        <div className="rounded-3xl md:rounded-[90px] bg-white w-full">
          <div className="w-full max-w-[1300px] mx-auto px-6 md:px-0 py-8 md:py-[60px]">
            <div className="flex flex-col md:flex-row px-10 justify-between gap-8 md:gap-0">
              {/* Logo & Info */}
              <div className="text-center md:text-left">
                <div className="flex justify-center md:justify-start items-center gap-0">
                  <svg width="161" height="37" viewBox="0 0 161 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_534_621)">
              ...
              {/* Navigation & Contacts */}
              <div className="flex flex-col md:flex-row gap-8 md:gap-20 text-center md:text-left">
                <div>
                  ...
                  <p className="text-sm text-gray-600 break-words">
                    ...
                    <a
                      ...
                      className="relative text-[#6f43f8] no-underline inline-block
                        ...
                        hover:after:w-full"
                      href="https://t.me/Igor_Dorofeev_tg/"
                    >
                      @Igor_Dorofeev_tg
                    </a>
                  </p>
            ...
            {/* Bottom bar */}
            <div className="mt-8 md:mt-12 flex flex-col md:flex-row px-10 items-center justify-between gap-4 border-t border-gray-200 pt-6">
              <span className="text-xs text-gray-500 text-center md:text-left">
                © 2026 IFOU. Все права защищены.
              </span>
              <div className="flex gap-10">
                <a href="https://digital-leaders.online/" target="_blank" rel="noopener noreferrer">
                  <img 
